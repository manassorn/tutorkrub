          ...
          <div className="row mx-0">
            ...
            <div className="row mt-3">
                <div className="col-2 col-md-3 align-self-center text-right pr-0">
                 <img className="" src="http://v.fastcdn.co/u/c787f3ba/25900801-0-arrow.png" width="60" />
                </div>
                <div className="col-10 col-md-9">
                  <div className="text-center radius-10 box-shadow py-3 bg-white text-weight-bold">
